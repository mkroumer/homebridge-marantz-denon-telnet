/**
    @fileoverview Add a homebridge platform-accessory with Service.Speaker for a marantz / Denon device.
...
var MarantzDenonTelnetSpeakerAccessory = function(platform, device, zoneId, zonename) {
    ...
    var accessory = new Accessory(device.friendlyName + ' ' + zonename, uuid);
    ...
    platform.log('MK >> dump accessory: ' + JSON.stringify(accessory));
    platform.log('MK >> dump service: ' + JSON.stringify(Service.Speaker));
